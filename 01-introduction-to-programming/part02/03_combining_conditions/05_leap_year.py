# Generally, any year that is divisible by four is a leap year. However, if the year is
# additionally divisible by 100, it is a leap year only if it also divisible by 400.
