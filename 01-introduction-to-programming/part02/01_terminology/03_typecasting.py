...
# For example, a floating point number can be converted into an integer with the function
# int:
...
# Notice the function always rounds down, and not according to the rounding rules in
# mathematics. This is an example of a floor function.
